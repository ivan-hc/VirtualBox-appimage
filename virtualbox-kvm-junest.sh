...
APP=virtualbox-kvm
BIN="virtualbox"
DEPENDENCES="ca-certificates alsa-lib alsa-plugins libpulse pulseaudio jack2 alsa-tools alsa-utils pipewire pipewire-alsa pipewire-audio libpng gnutls openal xorg-xwayland wayland xorg-server xorg-apps curl virtualbox-kvm v4l-utils libva sdl2 kvantum qt6ct qt6-wayland mesa vulkan-icd-loader vulkan-mesa-layers libva-mesa-driver"
